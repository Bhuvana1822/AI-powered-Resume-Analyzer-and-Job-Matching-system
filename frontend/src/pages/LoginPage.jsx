    ...
    <div style={{ maxWidth: '440px', margin: '3rem auto' }}>
      <div className="card">
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          <div style={{ background: 'rgba(99, 102, 241, 0.15)', width: '48px', height: '48px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 0.8rem', color: '#6366f1' }}>
            <LogIn size={24} />
          </div>
          <h2 style={{ fontSize: '1.6rem', fontWeight: '700' }}>Welcome Back</h2>
          <p style={{ color: '#9ca3af', fontSize: '0.9rem' }}>Sign in to manage your resume analyses</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.9rem', color: '#9ca3af' }}>
          Don't have an account? <Link to="/register" style={{ color: '#6366f1', fontWeight: '600' }}>Register here</Link>
        </p>
      </div>
    </div>
  );
